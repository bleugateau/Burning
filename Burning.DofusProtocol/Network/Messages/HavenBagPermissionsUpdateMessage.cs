...
namespace Burning.DofusProtocol.Network.Messages
{
  public class HavenBagPermissionsUpdateMessage : NetworkMessage
  {
    ...
    public HavenBagPermissionsUpdateMessage(uint permissions)
    {
    ...
    public override void Deserialize(IDataReader reader)
    {
      ...
      if (this.permissions < 0U)
        throw new Exception("Forbidden value (" + (object) this.permissions + ") on element of HavenBagPermissionsUpdateMessage.permissions.");
    }
  }
}
