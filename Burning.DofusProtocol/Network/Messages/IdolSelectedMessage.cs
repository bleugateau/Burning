...
namespace Burning.DofusProtocol.Network.Messages
{
  public class IdolSelectedMessage : NetworkMessage
  {
    ...
    public IdolSelectedMessage(uint idolId, bool activate, bool party)
    {
      this.idolId = idolId;
    ...
    public override void Deserialize(IDataReader reader)
    {
      ...
      if (this.idolId < 0U)
        throw new Exception("Forbidden value (" + (object) this.idolId + ") on element of IdolSelectedMessage.idolId.");
    }
  }
}
